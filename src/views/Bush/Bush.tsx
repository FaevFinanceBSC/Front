...
const Bush: React.FC = () => {
  ...
  const faevBusdfarm = useFarmFromPid(1) // changed by nasir
  ...
  const poolsWithApy = pools.map((pool) => {
    ...
    if (pool.stakingTokenName === QuoteToken.FAEV) {
    ...
    <>
      <Header>
        ...
        <Heading size="md" color="text">
          <ul>
            <li>{TranslateString(580, 'Stake FAEV token and FAEV LPs to earn new tokens.')}</li>
        ...
        {/* <Text style={{ marginTop: '10px' }}>
          <AddressLink href="https://faev.medium.com/the-bush-next-evolution-d9e316be71f1" color="text" external>
