  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to FaevSwap.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
            ...
            <Text mb={3}>
              <LiquidityLink href="https://swap.faev.io/#/add/ETH/0xa2f0B35B93f39F19B010999aaa28Bd5A77eb40f4">
                {TranslateString(506, 'Get CAKE-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, FaevSwap burns the FAEV.')}
              <br />
          ...
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with FaevSwap, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
