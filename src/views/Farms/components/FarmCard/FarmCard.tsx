...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  const totalValue: BigNumber = useMemo(() => {
    // console.log('-- farm : ', farm.lpTotalInQuoteToken, farm.quoteTokenSymbol, bnbPrice.toNumber(), cakePrice.toNumber(), ethPrice.toNumber())
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'FAEV'
  ...
  return (
    <FCard>
      ...
      {farm.tokenSymbol === 'FAEV' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
        ...
        <div>
          ...
          <Text style={{ textAlign: 'center' }}>
            <Link
              ...
              fontSize="14px"
              mt="10px"
              href="https://faev.medium.com/partnership-with-apeswap-finance-c1dd2dd44eee"
              target="blank"
